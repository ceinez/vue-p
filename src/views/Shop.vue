    ...
    <div id="main">
            <div class="sku-box store-content">
                <div class="sort-option">
                    <ul class="line clear">
                        <li><a href="javascript:;" class="active">default</a></li>
                        <li><a href="javascript:;" class="">hot</a></li>
                        <li><a href="javascript:;" class="">price ∧</a></li>
                        <li><a href="javascript:;" class="">price ∨</a></li>
                    </ul>
                </div>
                <div class="gray-box">
                    <div class="item-box">
                          <ListItem :key="item.id" v-for="item in goodsData" :item1="item"></ListItem>
                    </div>
                </div>
                <!-- <prompt></prompt> -->
            </div>
...
export default {
  ...
  mounted(){
      this.$store.dispatch('goodsListAsynce',this.cate_id)
  },
  components:{
    ListItem,Tips
  }
